...
RUN mkdir -p /go/src/github.com/xiaowei520/e3w
ADD . /go/src/github.com/xiaowei520/e3w
WORKDIR /go/src/github.com/xiaowei520/e3w
...
COPY --from=backend /go/src/github.com/xiaowei520/e3w/e3w /app
